...
- (void)scene:(UIScene *)scene willConnectToSession:(UISceneSession *)session options:(UISceneConnectionOptions *)connectionOptions {
    ...
    // Creates an instance of UIWindow using the UIScene that came from the delegate method.
    ...
    // Sets the root view controller of the window’s instance.
    ...
    // Shows the current window and positions it in front of all other windows at the same level or lower.
